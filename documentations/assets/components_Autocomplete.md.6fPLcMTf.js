...
const _hoisted_14 = /* @__PURE__ */ createStaticVNode('<h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>The autocomplete component should:</p><ul><li>Be clearly labeled so it’s obvious to the merchant what type of options will be available</li><li>Limit the number of options displayed at once</li><li>Not be used within a popover</li><li>Indicate a loading state to the merchant while option data is being populated</li></ul><hr><h2 id="content-guidelines" tabindex="-1">Content guidelines <a class="header-anchor" href="#content-guidelines" aria-label="Permalink to &quot;Content guidelines&quot;">​</a></h2><p>The input field for autocomplete should follow the <a href="/components/TextField">content guidelines</a> for text fields.</p><hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>For an input field without suggested options, <a href="/components/TextField">use the text field component</a></li><li>For a list of selectable options not linked to an input field, <a href="/components/OptionList">use the option list component</a></li><li>For a text field that triggers a popover, <a href="/components/Combobox">use the combo box component</a></li></ul><hr><h2 id="accessibility" tabindex="-1">Accessibility <a class="header-anchor" href="#accessibility" aria-label="Permalink to &quot;Accessibility&quot;">​</a></h2><h3 id="structure" tabindex="-1">Structure <a class="header-anchor" href="#structure" aria-label="Permalink to &quot;Structure&quot;">​</a></h3><p>The autocomplete component is based on the <a href="https://www.w3.org/TR/wai-aria-practices-1.1/#combobox" target="_blank" rel="noreferrer">ARIA 1.2 combobox pattern</a> and the <a href="https://www.w3.org/TR/wai-aria-practices-1.2/#Listbox" target="_blank" rel="noreferrer">Aria 1.2 Listbox pattern</a>.</p><p>The autocomplete list displays below the text field or other control by default so it is easy for merchants to discover and use. However, you can change the position with the <code>preferredPosition</code> prop.</p><p>Autocomplete features can be challenging for merchants with visual, motor, and cognitive disabilities. Even when they’re built using best practices, these features can be difficult to use with some assistive technologies. Merchants should always be able to search, enter data, or perform other activities without relying on the autocomplete.</p>', 15);
...
const _hoisted_33 = /* @__PURE__ */ createStaticVNode('<h3 id="keyboard-support" tabindex="-1">Keyboard support <a class="header-anchor" href="#keyboard-support" aria-label="Permalink to &quot;Keyboard support&quot;">​</a></h3><ul><li>Give the autocomplete text input keyboard focus with the <kbd>tab</kbd> key (or <kbd>shift</kbd> + <kbd>tab</kbd> when tabbing backwards)</li><li>Access the list of options with the up and down arrow keys</li><li>Select an option that has focus with the <kbd>enter</kbd>/<kbd>return</kbd> key</li></ul>', 2);
