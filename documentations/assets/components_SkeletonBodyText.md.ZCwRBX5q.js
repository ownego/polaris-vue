...
const _hoisted_7 = /* @__PURE__ */ createStaticVNode('<h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>Skeleton body text component should:</p><ul><li>Be used with <a href="/components/SkeletonPage">Skeleton page</a> when page content loads all at once. Together, these components give merchants an indication of what the page layout will be once loaded.</li><li>Be used on its own, inside any content container component (like a <a href="/components/Card">card</a>), and when content loads after the main page load.</li><li>Try to match the number of lines to the content being loaded so it gives an accurate representation.</li></ul><hr><h2 id="content-guidelines" tabindex="-1">Content guidelines <a class="header-anchor" href="#content-guidelines" aria-label="Permalink to &quot;Content guidelines&quot;">​</a></h2><h3 id="skeleton-body-text" tabindex="-1">Skeleton body text <a class="header-anchor" href="#skeleton-body-text" aria-label="Permalink to &quot;Skeleton body text&quot;">​</a></h3><p>Show static content that never changes on a page and use skeleton loading for dynamic content. Skeleton body text can sometimes be used to represent non-typographic content such as forms. Don’t use placeholder content that will change when the page fully loads.</p>', 7);
...
const _hoisted_20 = /* @__PURE__ */ createStaticVNode('<hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>Use this component with <a href="/components/SkeletonPage">Skeleton page</a> and <a href="/components/SkeletonDisplayText">Skeleton display text</a> to represent the content of a page while it’s loading.</li><li>When giving feedback for in-context operations, use <a href="/components/ProgressBar">Progress bar</a> or <a href="/components/Spinner">Spinner</a> component.</li></ul>', 3);
