...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createBlock(_component_LegacyCard, { title: "Online store dashboard" }, {
    default: withCtx(() => [
      ...
      createVNode(_component_LegacyCardSection, { title: "Summary" }, {
        default: withCtx(() => [
          createVNode(_component_Text, { as: "p" }, {
            default: withCtx(() => [
...
const LegacyCardWithMultipleTitledSections = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  LegacyCardWithMultipleTitledSections as default
};
