...
const _hoisted_8 = /* @__PURE__ */ createStaticVNode('<div style="font-size:0.8125rem;"><h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>Skeleton thumbnail component should:</p><ul><li>Try to match the size of the thumbnail to the content being loaded so it gives an accurate representation.</li></ul><hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>Use this component with <a href="/components/SkeletonDisplayText">Skeleton display text</a> to represent the content of a card while it’s loading.</li></ul></div>', 1);
