...
const _hoisted_11 = /* @__PURE__ */ createStaticVNode('<h2 id="anatomy" tabindex="-1">Anatomy <a class="header-anchor" href="#anatomy" aria-label="Permalink to &quot;Anatomy&quot;">​</a></h2><p>![A diagram of the Listbox component showing the smaller primitive components it can be composed of.]</p><p>A listbox can be composed of:</p><ol><li><strong>Options:</strong> The individual options inside the Listbox that merchants can select or deselect.</li><li><strong>Dividers:</strong> Placed between items and are useful in complex lists when there’s a lot of information for the merchant to parse.</li><li><strong>Section headers:</strong> Used at the begining of a section when it’s necessary to call out the content being displayed. In most cases, the surrounding context should be enough for the merchant to understand the information in the list.</li></ol><hr><h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>Listboxes should:</p><ul><li>Be clearly labeled so it’s noticeable to the merchant what type of options will be available</li><li>Limit the number of options displayed at once</li><li>Indicate a loading state to the merchant while option data is being populated</li></ul><hr><h2 id="content-guidelines" tabindex="-1">Content guidelines <a class="header-anchor" href="#content-guidelines" aria-label="Permalink to &quot;Content guidelines&quot;">​</a></h2><h3 id="option-lists" tabindex="-1">Option lists <a class="header-anchor" href="#option-lists" aria-label="Permalink to &quot;Option lists&quot;">​</a></h3><p>Each item in a <code>Listbox</code> should be clear and descriptive.</p>', 12);
...
const _hoisted_27 = /* @__PURE__ */ createStaticVNode('<h2 id="patterns-that-use-listbox" tabindex="-1">Patterns that use <code>Listbox</code> <a class="header-anchor" href="#patterns-that-use-listbox" aria-label="Permalink to &quot;Patterns that use `Listbox`&quot;">​</a></h2><p>Location picker</p><hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>For a text field and popover container, <a href="/components/Combobox">use the combobox component</a></li><li><a href="/components/Autocomplete">Autocomplete</a> can be used as a convenience wrapper in lieu of Combobox and Listbox.</li></ul><hr><h2 id="accessibility" tabindex="-1">Accessibility <a class="header-anchor" href="#accessibility" aria-label="Permalink to &quot;Accessibility&quot;">​</a></h2><h3 id="structure" tabindex="-1">Structure <a class="header-anchor" href="#structure" aria-label="Permalink to &quot;Structure&quot;">​</a></h3><p>The <code>Listbox</code> component is based on the <a href="https://www.w3.org/TR/wai-aria-practices-1.2/#Listbox" target="_blank" rel="noreferrer">Aria 1.2 Listbox pattern</a>.</p><p>It is important to not present interactive elements inside of list box options as they can interfere with navigation for assistive technology users.</p>', 10);
