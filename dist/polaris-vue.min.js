(function (exports, Vue, vuePropertyDecorator) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    let Styles = class Styles extends Vue__default["default"] {
    };
    Styles = __decorate([
    ...
    function render$4(_ctx, _cache, $props, $setup, $data, $options) {
      return (Vue.openBlock(), Vue.createBlock(Vue.resolveDynamicComponent(_ctx.element), {
     ...
     * </h4>
     */
    let List$1 = class List extends Vue__default["default"] {
        constructor() {
            super(...arguments);
    ...
    __decorate([
        vuePropertyDecorator.Prop({ type: String, default: 'bullet' })
    ...
    let Item$1 = class Item extends vuePropertyDecorator.Vue {
        constructor() {
            super(...arguments);
     ...
     * </h4>
     */
    let List = class List extends Vue__default["default"] {
        constructor() {
            super(...arguments);
            this.element = this.type === 'bullet' ? 'ul' : 'ol';
        }
    ...
    let Item = class Item extends vuePropertyDecorator.Vue {
        constructor() {
            super(...arguments);
            this.className = this.$style.Item;
        }
    ...
    exports.List = script$3;
    exports.ListItem = script$2;
    exports["default"] = PolarisVue;

    Object.defineProperty(exports, '__esModule', { value: true });

    return exports;

})({}, Vue, vuePropertyDecorator);
