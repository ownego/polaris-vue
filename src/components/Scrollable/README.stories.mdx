...
<Meta
  title="Components / Behavior / Scrollable"
...
export const DefaultScrollable = (args, { argTypes }) => ({
...
export const ScrollToExample = (args, { argTypes }) => ({
