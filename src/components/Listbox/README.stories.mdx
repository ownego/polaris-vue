...
export const BasicListbox = (args) => ({
...
export const LoadingListbox = (args) => ({
...
export const ActionListbox = (args) => ({
...
export const CustomListbox = (args) => ({
...
export const ExampleListbox = (args) => ({
  components: { Listbox, ListboxOption, ListboxLoading, ListboxAction },
  setup() { return { args }; },
  template: `
  <Listbox v-bind="args">
