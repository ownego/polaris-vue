import { isElementInViewport } from '@polaris/utilities/is-element-in-viewport';
...
function getMenuFocusableDescendants(element: HTMLElement): NodeListOf<HTMLElement> {
  return element.querySelectorAll(MENUITEM_FOCUSABLE_SELECTORS) as NodeListOf<HTMLElement>;
}
