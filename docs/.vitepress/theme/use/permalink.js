/**
 * This file to customize permalink for markdown-it-anchor
 * Source: https://github.com/valeriangalliat/markdown-it-anchor/blob/master/permalink.js
 */
...
export const linkInsideHeader = makePermalink((slug, opts, anchorOpts, state, idx) => {
  const href = slug === 'frontmatter-title' ? '#' : opts.renderHref(slug, state)
