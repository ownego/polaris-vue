...
const _hoisted_32 = /* @__PURE__ */ createStaticVNode('<hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>To add actions to the top of a page, see the <a href="/polaris-vue/components/Page">page component’s</a> action props</li><li>To create a call to action within the context of other page content, use the <a href="/polaris-vue/components/Button">button component</a></li><li>To let merchants move through a collection of items that spans multiple pages, see the <a href="/polaris-vue/components/Pagination">pagination component</a></li></ul>', 3);
