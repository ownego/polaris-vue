...
const __pageData = JSON.parse('{"title":"Utilities","description":"","frontmatter":{"outline":false,"aside":false,"prev":false,"next":false,"title":"Utilities","description":"Utilities are core tools for managing the structure of the admin and global settings."},"headers":[],"params":{"category":"utilities","name":"Utilities"},"relativePath":"components/utilities.md","filePath":"category/utilities.md"}');
const __default__ = { name: "components/utilities.md" };
