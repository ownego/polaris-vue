...
const __pageData = JSON.parse('{"title":"Typography","description":"","frontmatter":{"outline":false,"aside":false,"prev":false,"next":false,"title":"Typography","description":"Establish hierarchy and communicate importance through text presentation."},"headers":[],"params":{"category":"typography","name":"Typography"},"relativePath":"components/typography.md","filePath":"category/typography.md"}');
const __default__ = { name: "components/typography.md" };
