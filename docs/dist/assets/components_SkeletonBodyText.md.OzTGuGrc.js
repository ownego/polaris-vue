...
const _hoisted_20 = /* @__PURE__ */ createStaticVNode('<hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>Use this component with <a href="/polaris-vue/components/SkeletonPage">Skeleton page</a> and <a href="/polaris-vue/components/SkeletonDisplayText">Skeleton display text</a> to represent the content of a page while it’s loading.</li><li>When giving feedback for in-context operations, use <a href="/polaris-vue/components/ProgressBar">Progress bar</a> or <a href="/polaris-vue/components/Spinner">Spinner</a> component.</li></ul>', 3);
