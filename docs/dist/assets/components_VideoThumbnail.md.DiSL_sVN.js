...
const __pageData = JSON.parse('{"title":"Video thumbnail","description":"","frontmatter":{"layout":"doc","title":"Video thumbnail","category":"Images and icons","examples":[{"fileName":"Default.vue","title":"Default","description":"Use as a play button for a video player within a media card."},{"fileName":"VideoThumbnailWithProgress.vue","title":"With progress","description":"Use to indicate the video’s play progress in relation to its duration."}],"description":"Video thumbnails are a clickable placeholder image. When clicked, it opens a video player within a modal or full screen.","head":[["meta",{"name":"keywords","content":"video VideoThumbnail updates new-features video-thumbnail feature-thumbnail education contextual-learning-system"}]],"keywords":[" video\\n  "," VideoThumbnail\\n  "," updates\\n  "," new features\\n  "," video thumbnail\\n  "," feature thumbnail\\n  "," education\\n  "," contextual learning system"],"previewImg":"/images/components/images-and-icons/video-thumbnail.png"},"headers":[],"relativePath":"components/VideoThumbnail.md","filePath":"components/VideoThumbnail/README.md"}');
const _sfc_main = { name: "components/VideoThumbnail.md" };
const _hoisted_1 = {
  ...
  /* @__PURE__ */ createBaseVNode("div", { class: "language-vue vp-adaptive-theme" }, [
    ...
    /* @__PURE__ */ createBaseVNode("pre", { class: "shiki shiki-themes github-light github-dark vp-code" }, [
      /* @__PURE__ */ createBaseVNode("code", null, [
        ...
        /* @__PURE__ */ createTextVNode("\n"),
        /* @__PURE__ */ createBaseVNode("span", { class: "line" }, [
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" } }, "    showVideoProgress")
        ]),
        /* @__PURE__ */ createTextVNode("\n"),
        /* @__PURE__ */ createBaseVNode("span", { class: "line" }, [
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" } }, "    thumbnailUrl"),
        ...
        /* @__PURE__ */ createBaseVNode("span", { class: "line" }, [
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" } }, "    :"),
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" } }, "videoProgress"),
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" } }, "="),
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" } }, '"'),
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#005CC5", "--shiki-dark": "#79B8FF" } }, "45"),
          /* @__PURE__ */ createBaseVNode("span", { style: { "--shiki-light": "#032F62", "--shiki-dark": "#9ECBFF" } }, '"')
        ]),
        /* @__PURE__ */ createTextVNode("\n"),
        /* @__PURE__ */ createBaseVNode("span", { class: "line" }, [
...
const _hoisted_6 = /* @__PURE__ */ createStaticVNode('<div style="font-size:0.8125rem;"><h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>Video thumbnails should:</p><ul><li>Be used with a media card</li><li>Use an image that communicates the subject of the video</li><li>Include a video timestamp</li><li>Capture an image from the video to give a preview of the video content</li><li>Be cropped to a 16:9 aspect ratio</li><li>Be centered on the subject and avoid cropping of important details, like a person’s head</li></ul><hr><h2 id="required-components" tabindex="-1">Required components <a class="header-anchor" href="#required-components" aria-label="Permalink to &quot;Required components&quot;">​</a></h2><ul><li>The video thumbnail should be wrapped in the <a href="/polaris-vue/components/MediaCard">media card</a> component.</li></ul><hr><h2 id="related-components" tabindex="-1">Related components <a class="header-anchor" href="#related-components" aria-label="Permalink to &quot;Related components&quot;">​</a></h2><ul><li>To present a small visual anchor for an object, <a href="/polaris-vue/components/Thumbnail">use the thumbnail component</a></li></ul><hr><h2 id="accessibility" tabindex="-1">Accessibility <a class="header-anchor" href="#accessibility" aria-label="Permalink to &quot;Accessibility&quot;">​</a></h2><p>Images included in video thumbnails are implemented as decorative background images so that they’re skipped by screen readers.</p><p>The play button is keyboard accessible and the <code>aria-label</code> includes a timestamp when the <code>videoLength</code> prop is set. For example, an 80 second video reads as “Play video of length 1 minute and 20 seconds”. If no <code>videoLength</code> prop is provided, the default label reads “Play video”.</p></div>', 1);
