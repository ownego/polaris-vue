...
const __pageData = JSON.parse('{"title":"Tables","description":"","frontmatter":{"outline":false,"aside":false,"prev":false,"next":false,"title":"Tables","description":"Display, organize, and sort data for merchants to analyze and take action on."},"headers":[],"params":{"category":"tables","name":"Tables"},"relativePath":"components/tables.md","filePath":"category/tables.md"}');
const __default__ = { name: "components/tables.md" };
