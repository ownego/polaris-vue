...
const _hoisted_7 = /* @__PURE__ */ createStaticVNode('<h2 id="best-practices" tabindex="-1">Best practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best practices&quot;">​</a></h2><p>The account component should:</p><ul><li>Be placed at the top of the Account page for the relevant sales channel</li><li>Identify the name of the platform or service merchants can connect to</li><li>Show whether the account is connected or disconnected so that merchants can easily connect or disconnect an account</li><li>Include a link to the relevant sales channel or platform terms and conditions, including information about any charges or fees that merchants may incur by using the channel or platform</li><li>Link to terms and conditions, which should open up on the sales channel developer’s website in a new browser window</li></ul><hr><h2 id="content-guidelines" tabindex="-1">Content guidelines <a class="header-anchor" href="#content-guidelines" aria-label="Permalink to &quot;Content guidelines&quot;">​</a></h2><h3 id="title" tabindex="-1">Title <a class="header-anchor" href="#title" aria-label="Permalink to &quot;Title&quot;">​</a></h3><p>The account connection title should be the name of the platform or service that merchants can connect to, followed by the word “account”. Write account connection titles in sentence case (capitalize the first word and proper nouns only).</p><h4 id="for-example" tabindex="-1">For example: <a class="header-anchor" href="#for-example" aria-label="Permalink to &quot;For example:&quot;">​</a></h4><ul><li>Facebook account</li><li>Mailchimp account</li><li>Instagram account</li></ul>', 9);
