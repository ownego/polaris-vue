...
import { d as defineComponent, h as ref, D as resolveComponent, o as openBlock, c as createElementBlock, I as createVNode, w as withCtx, p as unref } from "./framework.2IsXxFXf.js";
const _hoisted_1 = { style: { height: "225px" } };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "WithWrappingAction",
  setup(__props) {
    ...
    const actionBefore = {
      ...
      content: "Action with long name that will need to wrap on small display in order to have a nice display",
      ellipsis: true,
      helpText: "Help text",
      icon: PlusCircleIcon,
      wrapOverflow: true,
