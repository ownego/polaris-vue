      ...
      return openBlock(), createBlock(_component_Page, { fullWidth: "" }, {
        default: withCtx(() => [
          createVNode(_component_Layout, null, {
            default: withCtx(() => [
              createVNode(_component_LayoutSection, { variant: "oneHalf" }, {
                default: withCtx(() => [
                      ...
                      createVNode(_component_LegacyCardSection, { title: "Items" }, {
                        default: withCtx(() => [
                          createVNode(_component_ResourceList, {
                            ...
                            default: withCtx(() => [
                              (openBlock(), createElementBlock(Fragment, null, renderList(resourceItemsSecond, (item) => {
                                return createVNode(_component_ResourceItem, {
                                  key: item.id,
                                  id: item.id,
                                  url: item.url,
