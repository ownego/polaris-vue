...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createBlock(_component_Page, { fullWidth: "" }, {
    default: withCtx(() => [
      createVNode(_component_Grid, null, {
        default: withCtx(() => [
          createVNode(_component_GridCell, { "column-span": { xs: 6, sm: 3, md: 3, lg: 6, xl: 6 } }, {
            default: withCtx(() => [
...
const TwoColumn = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  TwoColumn as default
};
