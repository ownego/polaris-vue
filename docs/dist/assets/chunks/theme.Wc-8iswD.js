...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.4M9M_x1U.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  `);
    ...
    function fetchType(type, isExtra) {
      const url = isExtra ? `/assets/extra-types/${type}.json` : `/assets/components-types/${type}.json`;
      return new Promise((resolve, reject) => {
        fetch(url, {
          method: "GET",
          headers: {
      ...
      return unref(examples) && unref(examples).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("iframe", {
            ...
            ref_key: "iframeRef",
            ref: iframeRef,
            src: `/preview/${component.value}-${selectedFile.value}`,
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/chunks/VPLocalSearchBox.4M9M_x1U.js","assets/chunks/framework.2IsXxFXf.js"]
  }
